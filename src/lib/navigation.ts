export const navigation = [
  {
    ...
    links: [
      ...
      { title: 'Why front-end?', href: '/docs/introduction/why-frontend' },
      {
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        href: '/docs/code-craftsmanship/clean-code-rules',
      },
      {
  ...
  },
  {
    ...
    links: [
      { title: 'Typescript', href: '/docs/frontend-engineering/typescript' },
      {
      ...
      // {
      //   title: 'Loading',
      //   href: '/docs/frontend-engineering/loading',
      // },
      // {
      //   title: 'Rendering',
      //   href: '/docs/frontend-engineering/rendering',
      // },
    ],
  },
  {
    ...
    links: [
      {
        title: 'Localization',
        href: '/docs/user-experience/localization',
      },
      {
        title: 'Accessibility',
